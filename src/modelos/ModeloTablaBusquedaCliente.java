...
public class ModeloTablaBusquedaCliente extends AbstractTableModel {

    final String[] COLUMN_NAMES = {"ID","Nombre","Apellido","Apellido Materno","DNI","Tipo"}; //cambiar los titulos
    ArrayList<Cliente> lista = null;
    //retormanos el numero de elementos del array de datos

    public ModeloTablaBusquedaCliente(ArrayList lista) {
        super();
        this.lista = lista;
    }
