...
//Lista de inmuebles para agregar a un nuevo contrato
public class ModeloTablaInmuebleContrato extends AbstractTableModel {
    ...
    public ModeloTablaInmuebleContrato(ArrayList lista) {
        super();
        this.lista = lista;
    }
    ...
    public Object getValueAt(int fila, int columna) {
        if (fila > lista.size()) {
            ...
            switch (columna) {
                ...
                case 6: {
                    return lista.get(fila).getPropietario().getId()+" - "+lista.get(fila).getPropietario().getApellido()+" "+lista.get(fila).getPropietario().getNombre();
                }
