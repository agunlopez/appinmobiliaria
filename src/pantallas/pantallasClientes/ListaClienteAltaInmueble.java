 ...
 * @author Nahuel
 */
public class ListaClienteAltaInmueble extends javax.swing.JFrame {

    /**
     * Creates new form ListaPropietarios
     */
    public ListaClienteAltaInmueble() {
        initComponents();
        ...
        if(evt.getClickCount()==2){
         // AltaInmueble alta=new AltaInmueble();
				...
				String s=id+" - "+apellido+" "+nombre;
                               ...
                               AltaInmueble.propietario.setText(id+" - "+apellido+" "+nombre);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListaClienteAltaInmueble.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListaClienteAltaInmueble().setVisible(true);
            }
        });
    }
